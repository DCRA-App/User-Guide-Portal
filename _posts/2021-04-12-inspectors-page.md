...
### **Click on Inspectors from the main menu bar**
...
### **Status Column, where inspector's status indicated**
...
### **Also by clicking the location icon on the Inspector Details page the users would will be directed to the inspectors location on the map**
...
### **Sorting by Inspector's Last Name: by clicking the Inspector Column, the user will be able to sort the Inspectors list from A-Z to Z-A**
...
### **Sorting by Inspector's Status, by clicking the Status Column, the user will be abel to sort the Inspectors using status Tracking On and Off**
...
### **Clicking the Filters button will display the Inspector filters menu**
...
### **Filtering the list using Inspector Name: by clicking on the name box and typing inspector's name and selecting the inspectors name will let the user to filter the inspector from the list** 
...
### **Filtering the list using Inspector Type: by selecting All, Internal and External will let the user to filter the list using Inspector Type**
...
### **Filtering the list using Inspector Status: by selecting Tracking On, In Tranist, Inspecting and Tracking Off the user will be abel to filter the list depending upon their selection**
